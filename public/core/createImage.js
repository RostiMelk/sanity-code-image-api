...
export async function createImage(props) {
    ...
    try {
        ...
        const jetBrainsMonoData = await fs.readFile(path.join(process.cwd(), "fonts/jetbrains.ttf"));
        const interData = await fs.readFile(path.join(process.cwd(), "fonts/inter.ttf"));
